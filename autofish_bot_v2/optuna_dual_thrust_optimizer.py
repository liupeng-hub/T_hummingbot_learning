#!/usr/bin/env python3
"""
Optuna Dual Thrust 参数优化器

使用贝叶斯优化（Optuna）对 Dual Thrust 算法参数进行优化。

使用方法:
    python optuna_dual_thrust_optimizer.py --symbol BTCUSDT --date-range 20200101-20260310 --n-trials 50
"""
...
logger = logging.getLogger("optuna_dual_thrust_optimizer")

optuna.logging.set_verbosity(optuna.logging.WARNING)


class OptunaDualThrustOptimizer:
    """Optuna Dual Thrust 参数优化器"""
    ...
    def _generate_report(self, study: optuna.Study):
        ...
        report = f"""# Optuna Dual Thrust 参数优化报告
...
def main():
    parser = argparse.ArgumentParser(description="Optuna Dual Thrust 参数优化器")
    ...
    optimizer = OptunaDualThrustOptimizer(args.symbol, args.date_range)
